...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    choices: ['Le code plante (Crash)', 'Le programme retournera faussement 0 comme maximum', 'Le programme comprendera automatiquement et renverra le bon nombre négatif', 'Le tableau devient positif'],
    correctAnswerIndex: 1,
  },
  {
