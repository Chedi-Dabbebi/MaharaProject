...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    streak: 5,
    tasks: [
      { id: 'c1', title: 'Variables et types de base', duration: '15 min', xp: 45, completed: true },
      { id: 'c2', title: 'Structures conditionnelles', duration: '30 min', xp: 75, completed: false },
      { id: 'c3', title: 'Boucles et itérations', duration: '25 min', xp: 60, completed: false },
      { id: 'c4', title: 'Fonctions et modularité', duration: '20 min', xp: 50, completed: true },
      { id: 'c5', title: 'Résoudre un mini-exercice', duration: '20 min', xp: 50, completed: false },
    ],
  },
];
